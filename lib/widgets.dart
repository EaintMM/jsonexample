...
class SimpleObjectView extends StatelessWidget {
  const SimpleObjectView({Key? key, required this.simpleObject}) : super(key: key);
...
class SimpleObjectViewList extends StatelessWidget {
  const SimpleObjectViewList({Key? key, required this.simpleObjects}) : super(key: key);
...
class ComplexObjectView extends StatelessWidget {
  ...
  const ComplexObjectView({Key? key, required this.complexObject}) : super(key: key);
...
class ComplexObjectViewList extends StatelessWidget {
  const ComplexObjectViewList({Key? key, required this.complexObjects}) : super(key: key);
